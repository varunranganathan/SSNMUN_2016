...
public class BitmapLoader {
    ...
    public void loadBitmap(int resId, CircleImageView imageView) {
    ...
    class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        public BitmapWorkerTask(CircleImageView circleImageView) {
            // Use a WeakReference to ensure the ImageView can be garbage collected
            imageViewReference = new WeakReference<CircleImageView>(circleImageView);
        }
