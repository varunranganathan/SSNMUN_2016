...
/**
 * Created by vvvro on 8/20/2016.
 */
public class ImageButtonBitmapLoader {
        Context context;
        public ImageButtonBitmapLoader(Context mContext){
            context = mContext;
        }
        ...
        class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
            ...
            protected Bitmap doInBackground(Integer... params) {
                data = params[0];
                return decodeSampledBitmapFromResource(context.getResources(), data, 800, 725);
            }
